...
class Web3ExternalProvider extends web3_utils_1.Eip1193Provider {
    constructor(network, transport, token, host) {
        super();
        this.transport = transport;
        if (transport === types_js_1.Transport.HTTPS) {
            this.provider = new web3_providers_http_1.default(this.getRPCURL(network, transport, token, host));
        }
        else if (transport === types_js_1.Transport.WebSocket) {
            this.provider = new web3_providers_ws_1.default(this.getRPCURL(network, transport, token, host));
        }
    }
